 ...
 odoo.define('web_widget_timepicker', function (require) {
     ...
     var TimeWidget = datepicker.DateWidget.extend({
         ...
         setValue: function (value) {
             ...
             var formatted_value = value ? this._formatClient(value) : '00:00';
         ...
         getValue: function () {
             ...
             return value ? this._formatClient(value) : '00:00';
         },
         ...
         _setValueFromUi: function () {
             ...
             this.setValue(this._parseClient(value) || 0);
         },
     });
     ...
     var FieldTimePicker = FieldDate.extend({
         ...
         _formatValue: function (value) {
             let res = field_utils.format.float_time(value) || '00:00';
            //  console.log("RES: " + res);
             return res;
         },
